...
function ShowMsg($msg, $gourl, $onlymsg=0, $limittime=0)
{
    ...
    $htmlhead  = "<html>\r\n<head>\r\n<title>Oceantrade Holdeing Limited 提示信息</title>\r\n<meta http-equiv=\"Content-Type\" content=\"text/html; charset=gb2312\" />\r\n";
    ...
    else
    {
      ...
      function JumpUrl(){
        ...
        $rmsg .= "<div style='padding:6px;font-size:12px;border-bottom:1px solid #DADADA;background:#DBEEBD url({$GLOBALS['cfg_plus_dir']}/img/wbg.gif)';'><b>OceanForex 提示信息！</b></div>\");\r\n";
