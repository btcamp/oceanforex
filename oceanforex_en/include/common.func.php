...
/**
 *  短消息函数,可以在某个动作处理后友好的Tip information
 *
 * @param     string  $msg      消息Tip information
...
function ShowMsg($msg, $gourl, $onlymsg=0, $limittime=0)
{
    ...
    $htmlhead  = "<html>\r\n<head>\r\n<title>Oceanforex Tip information</title>\r\n<meta http-equiv=\"Content-Type\" content=\"text/html; charset=gb2312\" />\r\n";
    ...
    else
    {
      ...
      function JumpUrl(){
        ...
        $rmsg .= "<div style='padding:6px;font-size:12px;border-bottom:1px solid #DADADA;background:#DBEEBD url({$GLOBALS['cfg_plus_dir']}/img/wbg.gif)';'><b>Oceanforex Tip information！</b></div>\");\r\n";
