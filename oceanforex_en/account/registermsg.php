...
<?php
if ($success) {
	echo '<div><div style="font-family: helvetica, tahoma, arial, sans-serif; font-size: medium;"><div><div><font size="2" face="宋体"><span style="line-height: 21px;">Dear ' . $name . ' Sir/madam</span><strong style="line-height: 1.5;">：</strong></font></div><div style="line-height: normal;"><font size="2" face="宋体" style="line-height: 21px;"><br></font></div><div><font size="2" face="宋体">&nbsp;Hello! Thank you very much for your open Oceanforex trading account, we will be in 1-2 working days to review your account information, will tell you in the form of mail MT4 trading account and password. Please check your account information carefully, if there are any errors, please contact us, as follows:&nbsp;</font></div><div><font size="2" face="宋体"><br style="line-height: 23.3240013122559px;"><ul><li><font style="line-height: 21px;">[account name ]:' . $name . '</font><span style="line-height: 1.5;">&nbsp;</span></li><li><span style="line-height: 1.5;">[<span style="line-height: 1.5;">login account</span><span style="line-height: 1.5;">]</span><font style="line-height: 21px;">:</font><span style="line-height: 1.5;">&nbsp;' . $email . '</span></span></li><li><span style="line-height: 1.5;">[login password&nbsp;]</span><font style="line-height: 21px;">:</font><span style="line-height: 1.5;">&nbsp;' . $pwd . '</span></li></ul></font></div><div><font size="2" face="宋体"><br style="line-height: 23.3240013122559px;">After approval, you can choose your login Oceanforex website into gold, then you can login to trade the MT4 client terminal, welcome you to join Oceanforex, I wish you a happy trading!</font>&nbsp;</div></div><div><br></div><div style="line-height: normal; font-size: 14px;"><font face="楷体_GB2312"></font></div></div></div><div><includetail><!--<![endif]--></includetail></div>';
} else {
	echo 'You submit the wrong information, please resubmit';
}
?>
